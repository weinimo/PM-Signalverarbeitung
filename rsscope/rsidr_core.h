...
#define RS_ENGINE_REVISION                      "Rev 2.25, 07/2012"
#define RS_ENGINE_MAJOR_VERSION                 2L
#define RS_ENGINE_MINOR_VERSION                 25L
...
#define viCheckParm(fCall, parameterPosition, parameterName) \
                             error = (fCall);\
                             if (error < 0) \
                                 {Rs_SetErrorInfo(instrSession, VI_FALSE, error, Rs_ParamPositionError(parameterPosition), parameterName); goto Error;}
#endif
